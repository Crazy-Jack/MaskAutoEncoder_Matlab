...
% img = imread('./img/closure.png');
img = imread('./img/dounuts.png');
...
path_to_weights = "./weights/mae_pretrain_vit_base.mat";
...
%% Visulaize Attention
head_id = 5; % heads of continuality
% head_id = 7;
% head_id = 8;
[selectedCells] = visualizePointAttention(img, patchSize, AttentionScores.block_12.score, head_id);
